  ...
  return (
    <div id="features" className={layout.section}>
      <motion.div ref={ref} className='layout.sectionInfo'>
        ...
        className={styles.heading2}>You do the business, <br className='sm:block hidden'/> we'll handle the money,
        </motion.h2>
        <motion.p 
        initial={{ x: -500, opacity: 0 }}
        animate={featureCtrl}
        ...
        className={`${styles.paragraph} max-w-[470px] mt-5`}>With the right credit card, you can improve your financial life by building credit, earning rewards 
          and saving money, have a chat with us today.
        </motion.p>
